  ...
  return (
    <div className="min-h-screen bg-dark-bg flex flex-col items-center justify-center p-6 relative overflow-hidden text-dark-text font-sans">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        {/* Cancel & Hide Buttons */}
        <div className="mt-8 flex items-center justify-center gap-4 mx-auto w-full max-w-sm">
          {onCancel && (
            <button
              onClick={onCancel}
              className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-dark-muted hover:text-white hover:bg-red-500/20 hover:border-red-500/30 transition-all duration-300 text-sm font-medium group"
            >
          ...
          {onHide && (
            <button
              onClick={onHide}
              className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-dark-muted hover:text-white hover:bg-primary/20 hover:border-primary/30 transition-all duration-300 text-sm font-medium group"
            >
              <Clock size={16} weight="duotone" className="group-hover:text-primary transition-colors" />
              Background
            </button>
          )}
        </div>
